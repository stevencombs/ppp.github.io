...
4. Google Drive: Progressive web app (install from URL). Google seems to preparing for a day when Chrome OS apps are now more and use the more crossfunctional PWAs which allow extensions (such as TextExpander) to work within the apps.
5. Messages: Also a progressive web app (ran into this one by accident) on my work Mac.
...
10. Pixel Store: Daughter had a god experience getting her Pixel 3 replaced after random shutdowns issue.
11. OBS Studio: Speaking of video, I've found an amazing free application to produce multi-camera videos. Plans to use to supplment the podcast (although 4 above is already a good example).
12. OBS Studio: Want to capture Chrome OS screen from a device into application. First solution was a bust. Hopefully I can find something. Let me know if you have ideas.
13. Still working on transfering past episodes to the new web site and hope you are enjoying the new format. Let me know.

...
3. Google Home - no longer available on Google Store. Is a new one imminent?
4. [Lenovo Chromebook Duet](https://www.google.com/chromebook/device/lenovo-chromebook-duet/) - Featured on the Google Store. I want one but am waiting on the device to arrive at Amazon (currently only avaialble at Best Buy)
5. Pixel Phones - Rules (Settings/System/Rules) to silence, vibrate, and ring when you connect/disconnect to specific Wi-Fi networks.
...
10. Soli Sandbox - Play Store application to spur Pixel 4 Soli (radar) application development.
11. Google Action Blocks - Play Store application that creates large buttons on the home screen (with customizable icons) to access Google Assistant actions such as:
...
13. Chrome OS 83 - Released on on stable channel withe some new features you should check out such as:
...
15. Raspberry Pi - Upgraded to 8 Gb and a new 64bit OS.
16. I'm exploring the Commodore Plus/4 from the beginning. Come join me on my [YouTube channel](https://www.youtube.com/stevencombs).

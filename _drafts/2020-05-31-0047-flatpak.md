...
In this episode I share my favorite Crostini (Linux) application manager; [Flatpak](https://www.flatpak.org). Flatpak makes managing current versions of Linux applications easy.

**Programming note:** Pixel Buds 2 are on their way. Look for a full review in a future episode.
...
* Longtime listener Raul joined me for a YouTube Live marathon where I install Super Retroboy on a [Raspberry Pi Zero W](https://amzn.to/2XOiuHT) and place it into the wonderful [Retroflag GPi Case](https://amzn.to/3eD5LhZ). Thanks for keeping me company!
...
I'll add this information to my Linux (Crostini) resource page at <https://www.pixelpowerpodcast.com/linux>

## Addendum

1. Duo - Phone number free Duo on Android Tablets and Chrome OS and you can install it as a PWA!
2. Progressive Web Apps - Long touch shortcuts on Android coming soon
3. Progressive Web Apps - PWA Store is my new favorite directory; as opposed to Find PWA which I mentioned in [Episode 46](/0046). The PWA Store is also a PWA!
4. Progressive Web Apps - Flag found in Canary channel that may soon allow PWAs to launch at startup (Twitter for instance). Not even regular Chrome OS apps have that feature and this demonstrates the trend to PWA.
5. Google Assistant - I have a new [Geeni Breathe XL ](https://amzn.to/3dj6wwl) in my COVID office that works by voice and by routines.
6. Lenovo Chromebook Duet - I want one but am waiting on the device to arrive at Amazon.
7. Pixel Phones - Rules (Settings/System/Rules) to silence, vibrate, and ring when you connect/disconnect to specific Wi-Fi networks.
8. Google Action Blocks - New Android application that creates large buttons on the home screen (with customizable icons) to access Google Assistant actions such as:
...
9. Krita - Open source image create application comes to Android Play store and ups the quality of Android apps for Chrome OS and Android tablets.
10. Soli Sandbox - Play Store app to spur Pixel 4 Soli (radar) application development.
11. Google Home - no longer available on Google Store. Is a new one imminent?
12. Chrome OS 83 - Released on on stable channel withe some new features you should check out such as:
...
13. Google Nest mini - Free one available for some folks (check out my [latest Reddit post](https://www.reddit.com/r/pixelpowerpodcast/) for link). Mine is ordered and on the way.
15. Chrome OS - Type `chrome://dino` in the browser. When the dino page appears, tap on the dino or hit the space bar (depending on platform)
16. Raspberry Pi - Upgraded to 8 Gb and a new 64bit OS.
17. I'm exploring the Commodore Plus/4 from the beginning. Come join me on my [YouTube channel](https://www.youtube.com/stevencombs).
